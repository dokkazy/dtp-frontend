    ...
    >
      ...
      >
        ...
        <div className="p-3">
          <h3
            title={tour.title}
            className="mb-2 line-clamp-2 h-10 text-sm font-bold"
          >
            {tour.title}
          </h3>
          ...
          <div className="mb-2 flex items-center text-xs">
            <div className="inline-flex items-center text-yellow-500">
              ...
              <span className="ml-1 font-medium">{tour.avgStar.toFixed(1)}</span>
              <span className="ml-1 text-gray-600 font-medium">({tour.totalRating})</span>
              <span className="mx-1 text-gray-400">•</span>
              <span className="text-gray-600 font-medium">10+ Đã đặt</span>
            </div>
          </div>

          <div className="flex items-end justify-between">
            <div className="flex gap-2">
              <span className="text-xs text-gray-500 font-semibold">Từ</span>
